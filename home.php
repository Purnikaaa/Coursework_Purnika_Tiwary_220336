...
<body>
  ...
  <div class="container">
    <div class="content">
      ...
      <a href="create.php" class="button">Create a Blog <span class="button-icon">+</span></a><br /><br />
      <a href="blog.php" class="button">Read a Blog <span class="button-icon">&rarr;</span></a>
    </div>
    <div class="image">
